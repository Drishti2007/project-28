...
function setup() {
   ...
   tree1 = new Tree(1000,250,400,400);
   mango = new Mango(1005,400,100,100);
   mango2 = new Mango(960,290,100,100);
   mango3 = new Mango(1070,445,100,100);
   mango4 = new Mango(880,350,100,100);
   mango5 = new Mango(920,480,100,100);
   mango6 = new Mango(1140,380,100,100);
   mango7 = new Mango(1010,460,100,100);
